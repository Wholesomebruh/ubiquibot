...
export const MergedConfigSchema = Type.Object({
  readonly "evm-network-id": Type.Number(),
  readonly "price-multiplier": Type.Number(),
  readonly "private-key-encrypted": Type.Optional(Type.String()),
  readonly "issue-creator-multiplier": Type.Number(),
  readonly "time-labels": Type.Array(LabelItemSchema),
  readonly "priority-labels": Type.Array(LabelItemSchema),
  readonly "payment-permit-max-price": Type.Number(),
  readonly "command-settings": Type.Array(CommandItemSchema),
  readonly "promotion-comment": Type.String(),
  readonly "disable-analytics": Type.Boolean(),
  readonly "comment-incentives": Type.Boolean(),
  readonly "assistive-pricing": Type.Boolean(),
  readonly "max-concurrent-assigns": Type.Number(),
  readonly incentives: IncentivesSchema,
  readonly "default-labels": Type.Array(Type.String()),
  readonly "register-wallet-with-verification": Type.Boolean(),
  readonly "enable-access-control": AccessControlSchema,
  readonly "stale-bounty-time": Type.String(),
});
